	...
	function loadChanges() {
		...
		function prepareChanges() {
			...
			if (usePreviewConnector()) {
				...
				oChanges = {
					changes: oResult,
					componentClassName: "com.sun.pp.samplesummarydetail"
				};
			}
		...
		return new Promise(function (resolve, reject) {
			$.ajax({
				...
				function isMTAChange(sPath) {
					...
					return sPath.startsWith("samplesummarydetail") && sPath.indexOf("webapp/changes/") > 0 && isValidChangeFileExt(sPath);
				}
